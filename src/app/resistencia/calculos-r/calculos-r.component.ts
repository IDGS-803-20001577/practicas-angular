...
export class CalculosRComponent {
  ...
  calcular() {
    ...
    //se saca el color de la banda
    this.valorResistencia = (value1 * Math.pow(10, value2)).toString();

    const valor3 = value1 * Math.pow(10, value2);
    ...
    this.max_valor = (valor3 * (1 + this.valorTolerancia)).toString();
    this.min_valor = (valor3 * (1 - this.valorTolerancia)).toString();
  }
